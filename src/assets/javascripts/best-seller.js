...
.then(function(data) {
    ...
    data.listBestSeller.forEach(item => {
        render += `
            ...
            <div class="rounded-xl item-hover">
              <div class="icons float-right mr-4 mt-4 flex flex-col gap-5">
                <img
                  ...
                  src="https://etasycandy.github.io/FOM/src/assets/images/icon-share.png"
                  alt="share"
                />
                <img
                  class="cursor-pointer"
                  src="https://etasycandy.github.io/FOM/src/assets/images/icon-like.png"
                  alt="like"
                />
              </div>
              <button
    ...
    document.getElementById("list-bestseller").innerHTML = render
